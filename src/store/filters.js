  ...
  state: {
    ...
    people: [
      ...
      },
      {
        ...
        img:
          "../../../business.wpdiy.net/wp/wp-content/uploads/2015/04/Ailene_McDott-300x300.jpg",
        order: 1
      },
      {
        id: "lm003",
        ...
        img:
          "../../../business.wpdiy.net/wp/wp-content/uploads/2015/04/kristiann_ng-300x300.jpg",
        order: 2
      },
      {
        id: "lm004",
        ...
        img:
          "../../../business.wpdiy.net/wp/wp-content/uploads/2015/04/Geena-Draper-300x300.jpg",
        order: 3
      },
      {
        id: "lm005",
        ...
        img:
          "../../../business.wpdiy.net/wp/wp-content/uploads/2015/04/Arnold_Rickshaw-300x300.jpg",
        order: 4
      },
      {
        id: "lm006",
        ...
        title: "Design Intern",
        bio:
          "Luisa is an intern in our design department.  This photo was taken by Joe Gardner on unsplash.com.  The rest of the bio did not originally appear on the Leaf & Mortar website, but we need a little placeholder text to fill out the page.  You understand.",
      ...
      },
      {
        ...
        bio:
          "Issa is an intern in our architecture department.  This photo was taken by Joe Gardner on unsplash.com.  The rest of the bio did not originally appear on the Leaf & Mortar website, but we need a little placeholder text to fill out the page.  You understand.",
      ...
      },
      {
        ...
        title: "Support Staff",
        bio:
          "Jake has been keeping things running for the past five years. This photo was taken by Lucas Sankey on unsplash.com.  The rest of the bio did not originally appear on the Leaf & Mortar website, but we need a little placeholder text to fill out the page.  You understand.",
